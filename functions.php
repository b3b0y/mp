...
class Baroque_Awards {
	...
	public function __construct() {
		...
		add_filter( 'post_type_link', array( $this, 'award_post_type_link' ), 9, 2 );
		add_filter( 'attachment_link', array( $this, 'award_attachment_link' ), 9, 2 );
	...
	public function register_post_type() {
		...
		register_post_type(
			...
			'description'         => esc_html__( 'Awards Items', 'baroque' ),
			'labels'              => array(
				'name'                  => esc_html__( 'Awards', 'baroque' ),
...
function show_award_fields_meta_box() {
    ...
    <!-- All fields will go here -->
		<p>
			<label for="award_fields[text]">Sub Title </label>
			<br>
			<input type="text" name="award_fields[text]" id="award_fields[text]" class="regular-text" value="<?php echo ($meta != '') ? $meta['text'] : ''; ?>">
		</p>
